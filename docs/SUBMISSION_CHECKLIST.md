...
| 8 | Hindi localisation | **Met** | 570 keys. `MissingTranslation` is a fatal lint check and lint passes with 0 errors. |
| 9 | Santali localisation | **Met (needs native review)** | 570 keys in Ol Chiki. Complete and usable; wording should be reviewed by a native speaker familiar with mine-site vocabulary before a field pilot. Coverage and quality are separate claims and both are stated. |
